...
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (1,NULL,'ROLE','Role',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (2,1,'ACCT','Account',NULL);

INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (3,NULL,'ANNC','Announcement',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (4,3,'COMT','Comment',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (5,3,'HVOT','HouseVoting',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (6,5,'VOPT','VotingOption',NULL);

INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (7,2,'APT','Apartment',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (8,2,'MNG','Manager',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (9,NULL,'MNGBLL','ManagerBill',NULL);

INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (10,NULL,'CALC','CalculationMethod',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (11,10,'COMUNUTL','CommunalUtility',NULL);

INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (12,11,'SBLL','SubBill',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (13,12,'APTSBLL','ApartmentSubBill',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (14,12,'MNGSBLL','ManagerSubBill',NULL);

INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (15,NULL,'OPR','Operation',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (16,15,'DPAYOPR','DebtPaymentOperation',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (17,15,'APTOPR','ApartmentOperation',NULL);
INSERT INTO OBJTYPE_STAGING (OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION) VALUES (18,15,'MNGOPR','ManagerSpendingOperation',NULL);


-- Merge with OBJTYPE table
MERGE INTO OBJTYPE x
USING (SELECT OBJECT_TYPE_ID,PARENT_ID,CODE,NAME,DESCRIPTION FROM OBJTYPE_STAGING) y
ON (x.OBJECT_TYPE_ID  = y.OBJECT_TYPE_ID)
WHEN MATCHED THEN
    UPDATE SET x.PARENT_ID = y.PARENT_ID, 
                        x.CODE = y.CODE, 
                        x.NAME = y.NAME,
...
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (15,7,NULL,'APTNUM','apartment_number');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (16,7,NULL,'SQUARE','square_metres');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (17,7,NULL,'FLOOR','floor');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (18,7,NULL,'PPLCOUNT','people_count');

--Manager(OBJECT_TYPE_ID=8) attributes

--ManagerBill(OBJECT_TYPE_ID=9) attributes
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (19,9,NULL,'CARDNUM','card_number');

--CalculationMethod(OBJECT_TYPE_ID=10) attributes
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (20,10,NULL,'CALCNAME','name');

--CommunalUtility(OBJECT_TYPE_ID=11) attributes
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (21,11,NULL,'COMUNNAME','name');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (22,11,NULL,'DURTYPE','duration_type');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (23,11,NULL,'STATUS','status');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (24,11,NULL,'DLINE','deadline');

--SubBill(OBJECT_TYPE_ID=12) attributes
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (25,12,NULL,'BALANCE','balance');

--ApartmentSubBill(OBJECT_TYPE_ID=13) attributes
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (38,13,NULL,'DEBT','debt');
--ManagerSubBill(OBJECT_TYPE_ID=14) attributes

--Operation(OBJECT_TYPE_ID=15) attributes
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (26,15,NULL,'SUM','sum');
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (27,15,NULL,'CREATEDAT','created_at');
...
INSERT INTO ATTRTYPE_STAGING (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (28,18,NULL,'DESCR','description');
