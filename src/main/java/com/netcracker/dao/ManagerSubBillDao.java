...
public interface ManagerSubBillDao {
    ...
    String ALL_APARTMENT_SUB_BILLS_DEBT_BY_COMMUNAL_UTILS_LIST =
            "SELECT SUM(DEBT.VALUE) debt, COMMUNAL_NAME.VALUE, COMMUNAL_UTILL.OBJECT_ID communal_util_id\n" +
