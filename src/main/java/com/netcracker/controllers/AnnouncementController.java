...
public class AnnouncementController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ROLE_MANAGER','ROLE_OWNER')")
    public Announcement getAnnouncement(@PathVariable BigInteger id) throws DaoAccessException, NullPointerException {
    ...
    @PostMapping("/{id}")
    @PreAuthorize("hasAnyRole('ROLE_MANAGER')")
    public Announcement updateAnnouncement(@RequestBody @Valid Announcement announcement, @PathVariable BigInteger id)
            throws DaoAccessException, NullPointerException {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyRole('ROLE_MANAGER')")
    public void deleteAnnouncement(@PathVariable BigInteger id) throws DaoAccessException, NullPointerException {
